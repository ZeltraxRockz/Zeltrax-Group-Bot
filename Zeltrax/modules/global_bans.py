...
import Zeltrax.modules.sql.global_bans_sql as sql
from Zeltrax import (
    dispatcher,
    OWNER_ID,
    SUDO_USERS,
...
from Zeltrax.modules.helper_funcs.chat_status import user_admin, is_user_admin
from Zeltrax.modules.helper_funcs.extraction import extract_user, extract_user_and_text
from Zeltrax.modules.helper_funcs.filters import CustomFilters
from Zeltrax.modules.helper_funcs.alternate import typing_action, send_action
from Zeltrax.modules.sql.users_sql import get_all_chats
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @ZeltraxChat if you think it's a Mistake !"
    else:
        text = text.format("No")
    return text
...
Zeltrax Group Bot 【★🆉🆁™】 will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
