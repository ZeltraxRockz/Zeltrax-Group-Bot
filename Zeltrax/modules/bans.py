...
from Zeltrax.modules.helper_funcs.extraction import extract_user_and_text
from Zeltrax.modules.helper_funcs.string_handling import extract_time
from Zeltrax.modules.helper_funcs.admin_rights import user_can_ban
...
def ban(update, context):
    ...
    try:
        ...
        context.bot.sendMessage(
            chat.id,
            "{} Got Crushed By Zeltrax Hammer !".format(
                mention_html(member.user.id, member.user.first_name)
            ),
