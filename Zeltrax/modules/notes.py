...
from Zeltrax import dispatcher, MESSAGE_DUMP, LOGGER
from Zeltrax.modules.disable import DisableAbleCommandHandler
from Zeltrax.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Zeltrax.modules.helper_funcs.admin_rights import user_can_changeinfo
from Zeltrax.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Zeltrax.modules.helper_funcs.msg_types import get_note_type
from Zeltrax.modules.helper_funcs.string_handling import (
...
def list_notes(update, context):
    ...
    if not note_list:
        ...
        try:
            ...
            update.effective_message.reply_text(
                "There was a problem in showing notes list, maybe due to some invalid character in note names. Ask in @ZeltraxChat if you're unable to figure it out!"
            )
