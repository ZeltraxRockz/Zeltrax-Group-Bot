...
def gtts(update, context):
    ...
    try:
        tts = gTTS(reply)
        tts.save("ZeltraxGroupManagerBot.mp3")
        with open("ZeltraxGroupManagerBot.mp3", "rb") as speech:
            msg.reply_audio(speech)
    finally:
        if os.path.isfile("ZeltraxGroupManagerBot.mp3"):
            os.remove("ZeltraxGroupManagerBot.mp3")
