...
import Zeltrax.modules.sql.notes_sql as sql
from Zeltrax import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from Zeltrax.__main__ import DATA_IMPORT
from Zeltrax.modules.helper_funcs.chat_status import user_admin
from Zeltrax.modules.helper_funcs.alternate import typing_action

# from Zeltrax.modules.rules import get_rules
import Zeltrax.modules.sql.rules_sql as rulessql

# from Zeltrax.modules.sql import warns_sql as warnssql
import Zeltrax.modules.sql.blacklist_sql as blacklistsql
from Zeltrax.modules.sql import disable_sql as disabledsql

# from Zeltrax.modules.sql import cust_filters_sql as filtersql
# import Zeltrax.modules.sql.welcome_sql as welcsql
import Zeltrax.modules.sql.locks_sql as locksql
from Zeltrax.modules.connection import connected
...
def export_data(update, context):
    ...
    f = open("Zeltrax{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Zeltrax{}.backup".format(chat_id), "rb"),
        caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Zeltrax-Backup` is specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Zeltrax{}.backup".format(chat_id))  # Cleaning file
