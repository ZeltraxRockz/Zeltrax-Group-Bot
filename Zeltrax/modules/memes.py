...
from Zeltrax.modules.helper_funcs.extraction import extract_user
...
from Zeltrax import dispatcher, SUDO_USERS, SUPPORT_USERS, LOGGER
from Zeltrax.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler

import Zeltrax.modules.helper_funcs.fun_strings as fun
...
`/decide` can be also used with regex like: `Zeltrax? <question>: randomly answer "Yes, No" etc.`
...
DECIDE_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"(?i)^Zeltrax\?"), decide, friendly="decide"
)
