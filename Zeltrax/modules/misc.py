...
from Zeltrax.__main__ import STATS, USER_INFO, GDPR
...
def info(update, context):
    ...
    del_msg = msg.reply_text(
        "Hold tight while I steal some data from <b>Zeltrax's Database</b>...😉😉",
...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Zeltrax Group Bot 【★🆉🆁™】 data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [Here](t.me/ZeltraxRockz) .",
        parse_mode=ParseMode.MARKDOWN,
        disable_web_page_preview=True,
    )
