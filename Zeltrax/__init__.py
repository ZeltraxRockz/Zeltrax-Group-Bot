...
if ENV:
    ...
    from Zeltrax.config import Development as Config
...
client = TelegramClient("Zeltrax", api_id, api_hash)
...
from Zeltrax.modules.helper_funcs.handlers import CustomCommandHandler
